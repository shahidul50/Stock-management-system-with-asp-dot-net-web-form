<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanySetupUI.aspx.cs" Inherits="StockManagementSystemWebApp.UI_Design.CompanySetupUI" %>
...
<body>
                        ...
                        <div class="mainsection col-sm-9 float-right">
                             ...
                             <div class="row">
                                  <div class="mainsectionheader  col-sm-12 ">
                                       <h3 class="text-center">Company Setup</h3>
                                  </div>
                            </div>
                                        ...
                                        <table>
                                            <tr>
                                                <th class="auto-style1">
                                                    <asp:Label ID="Label2" runat="server" Text="Name" CssClass="part1"></asp:Label>
                                                </th>
                                                <th class="auto-style1">
                                                    <asp:TextBox ID="companyNameTextBox" runat="server" Width="340px" Height="40px" class="part2" placeholder="Enter a Company Name" style ="margin-right: 15px;"></asp:TextBox>
                                                </th>
                                            </tr>
                                         ...
                                         <div class="col-sm-12 sbutton">
                                              <asp:Button ID="companySaveButton" runat="server" Text="Save" Width="126px" Height="47px" class="bg-success text-white font-weight-bold " OnClick="companySaveButton_Click" />
                                         </div>
                                    <div class="Gridview">
                                        <br />
                                        <asp:GridView ID="companyGridView" runat="server" AutoGenerateColumns="False" Height="168px" Width="704px" CellPadding="4" ForeColor="#333333" GridLines="None">
    ...
    <script>
        $('#companyForm').validate({
            ...
            messages: {
                companyNameTextBox: "Please enter your company"
            }
        });
    </script>
</body>
